...
class FastBasicNet:
    ...
    def init_params(self):
        ...
        self.params['W2'] = np.random.randn(64, 50) * SIGMA
        self.params['b2'] = np.random.rand(50) * SIGMA
        self.params['W3'] = np.random.randn(50, 40) * SIGMA
        self.params['b3'] = np.random.rand(40) * SIGMA
        self.params['W4'] = np.random.randn(40, 30) * SIGMA
        self.params['b4'] = np.random.rand(30) * SIGMA
        self.params['W5'] = np.random.randn(30, 30) * SIGMA
        self.params['b5'] = np.random.rand(30) * SIGMA
        self.params['W6'] = np.random.randn(30, 30) * SIGMA
        self.params['b6'] = np.random.rand(30) * SIGMA
        self.params['W7'] = np.random.randn(30, 10) * SIGMA
        self.params['b7'] = np.random.rand(10) * SIGMA
...
if __name__ == '__main__':
    ...
    pickle.dump(log, open(path.join(path.dirname(__file__ ), 'naive_seven_layer_log.pkl'), "wb"))
